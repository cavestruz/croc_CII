...
yt.add_field(("gas", "H_p0_number_density"), function=_HI_number_density, units="1/cm**3",sampling_type="local") # Adds additional field for YTEP 0003 and Trident compatability

def _HII_number_density(field, data):
    return data["HII density"]/(H_mass-electron_mass)
yt.add_field(("gas", "HII number density"), function=_HII_number_density, units="1/cm**3",sampling_type="local",sampling_type="local")
