...
// If cooling radiation dominates - diffuse ISM - CROC is sufficient.
// IF dominated by PDR, then we need 10pc scale.  This is an
// exploratory project, tellign you where to go from here.  Higher
// resolution needed?  Followup depends on results.
